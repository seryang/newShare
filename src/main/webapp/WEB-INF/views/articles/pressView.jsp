...
<title>newShare - ${requestScope.pressName}</title>
...
<body>
	...
	<div class="container">
		...
		<div id="wrapper">
			...
			<table class="plList">
				<tr>
					<td width="20%" valign=top align=left class="plListMenu"><br>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">종합<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="038" class="press">한국일보</a></li>
										</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">방송/통신<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="052" class="press">YTN TV</a></li>
										</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">경제<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="375" class="press">SBS CNBC</a></li>
										</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">인터넷<b class="caret"></b></a>
										<ul class="dropdown-menu">
											<li><a id="079" class="press">노컷뉴스</a></li> 
											<li><a id="119"	class="press">데일리안</a></li> 
											<li><a id="006" class="press">미디어오늘</a></li> 
											<li><a id="047" class="press">오마이뉴스</a></li> 
											<li><a id="143" class="press">쿠키뉴스</a></li> 
											<li><a id="002" class="press">프레시안</a></li>
										</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">IT<b class="caret"></b></a>
										<ul class="dropdown-menu">
											<li><a id="138" class="press">IT</a></li> 
											<li><a id="029"	class="press">디지털타임스</a></li> 
											<li><a id="293" class="press">블로터닷넷</a></li>
											<li><a id="031" class="press">아이뉴스</a></li>
											<li><a id="030" class="press">전자신문</a></li>
											<li><a id="092" class="press">ZDNet Korea</a></li>
										</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">스포츠/연예<b class="caret"></b></a>
										<ul class="dropdown-menu">
											<li><a id="216" class="press">골닷컴</a></li>
											<li><a id="435"	class="press">골프다이제스트</a></li>
											<li><a id="420" class="press">네이버연예</a></li>
											<li><a id="447" class="press">뉴스엔</a></li>
											<li><a id="347" class="press">데일리e스포츠</a></li>
											<li><a id="439" class="press">디스이즈게임</a></li> 
											<li><a id="433" class="press">디스패치</a></li>
											<li><a id="425" class="press">마니아리포트</a></li>
											<li><a id="117" class="press">마이데일리</a></li>
											<li><a id="343" class="press">베스트일레븐</a></li>
											<li><a id="316" class="press">순스포츠</a></li>
											<li><a id="108" class="press">스타뉴스</a></li>
											<li><a id="144" class="press">스포츠경향</a></li>
											<li><a id="382" class="press">스포츠동아</a></li>
											<li><a id="073" class="press">스포츠서울</a></li>
											<li><a id="076" class="press">스포츠조선</a></li>
											<li><a id="139" class="press">스포탈코리아</a></li>
											<li><a id="302" class="press">아이웨이미디어</a></li>
											<li><a id="311" class="press">엑스포츠뉴스</a></li>
											<li><a id="275" class="press">엠파이트</a></li>
											<li><a id="442" class="press">인벤</a></li>
											<li><a id="413" class="press">인터풋볼</a></li>
											<li><a id="241" class="press">일간스포츠</a></li>
											<li><a id="065" class="press">점프볼</a></li>
											<li><a id="111" class="press">조이뉴스</a></li>
											<li><a id="312" class="press">텐아시아</a></li>
											<li><a id="440" class="press">티브이데일리</a></li>
											<li><a id="236" class="press">포모스</a></li>
											<li><a id="112" class="press">헤럴드생생뉴스</a></li>
											<li><a id="404" class="press">enews24</a></li>
											<li><a id="408" class="press">imbc</a></li>
											<li><a id="438" class="press">KBS 연예</a></li>
											<li><a id="410" class="press">MK스포츠</a></li>
											<li><a id="427" class="press">OBS TV</a></li>
											<li><a id="109" class="press">OSEN</a></li>
											<li><a id="416" class="press">SBS funE</a></li>
											<li><a id="213" class="press">TV리포트</a></li>
										</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">매거진<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="050" class="press">한경비즈니스</a></li>
										</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">전문지<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="346" class="press">헬스조선</a></li>
										</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">지역<b class="caret"></b></a>
										<ul class="dropdown-menu">
											<li><a id="087" class="press">강원일보</a></li>
											<li><a id="088" class="press">매일신문</a></li>
											<li><a id="082" class="press">부산일보</a></li>
										</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">포토<b class="caret"></b></a>
										<ul class="dropdown-menu">
											...
											<li><a id="091" class="press">EPA연합뉴스</a></li>
										</ul></li>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
										...
										<ul class="dropdown-menu">
											...
											<li><a id="441" class="press">코리아넷</a></li>
										</ul></li>
					</td>
					<td>
							<ul id="articles">
							<br>
								<c:forEach var="art" items="${requestScope.articles}">
									<li class="articles">
										<dl>
											<dt class="photo" style="float: left">
												<img src="${art.image}">
											</dt>
											<dt> 
												<a style="padding:5px; font-size:12px; cursor:pointer;" class="articleTitle"> ${art.title} </a>&nbsp;
												<a class="scrap" style="color: brown; cursor: pointer; text-align:right;">[스크랩하기]</a>
											</dt>
											<dd>
												${art.description}
												<span class="writingDate">${art.writingDate}</span>
											</dd>
										</dl>
									</li>
								</c:forEach>
	...
	$(document).ready(function() {
		...
		$(".scrap").click(function() {
			var title = $(this).siblings(".articleTitle").text();
