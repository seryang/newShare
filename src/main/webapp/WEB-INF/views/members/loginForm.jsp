	...
	<div class="container">
		...
		<div id="wrapper">
			...
			<div class="row-fluid" align="center">
				...
				<div class="loginForm span6" align="center" style="float:none;">
					<form id="loginInfo" class="form-horizontal" role="form" onSubmit="return false;">
						...
						<hr>
						<input type="submit" class="ctn ctn-primary" value="Login">
						<input type="reset" class="ctn ctn-primary" value="Reset"><br>
					</form>
					<a href="insertForm.do">아직 회원이 아니신가요?&nbsp;&nbsp;&nbsp;</a>/<a
						href="passwordSearchForm.do">&nbsp;&nbsp;&nbsp;패스워드를 잊어버리셨나요?</a>
				</div>
			</div>
			<!-- end: Row -->
		</div>
