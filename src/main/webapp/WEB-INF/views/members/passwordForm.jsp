	...
	<div class="container">
		...
		<div id="wrapper">
			...
			<div class="row-fluid" align="center">
				<p class="text-info">* 개인정보 보호를 위해 비밀번호를 입력해주세요.</p>
				<div class="passwordCheckForm span6" align="center" style="float:none;">
					<form id="passwordInfo"  class="form-horizontal" role="form" onSubmit="return false;">
						...
						<hr>	
						<input type="submit" class="ctn ctn-primary" value="Confirm"> 
